...
import { DragDropContext, Droppable, Draggable } from "react-beautiful-dnd"; // You'll need to install this package
...
const SlotBookingsModal = ({
    ...
    const handleDragEnd = (result) => {
        ...
        const items = Array.from(slotBookings);
                ...
                <div className="p-6">
                    {slotBookings.length === 0 ? (
                        ...
                        <DragDropContext onDragEnd={handleDragEnd}>
                            <Droppable droppableId="bookings">
                                {(provided) => (
                                    <div
                                        className="space-y-4"
