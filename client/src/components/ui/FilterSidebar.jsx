                ...
                >
                    {showFilters ? (
                        <>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1 cursor-pointer" viewBox="0 0 20 20" fill="currentColor">
            ...
            >
                ...
                <div className="border-b-2 border-[#4e77f4]/80 pb-4">
                    ...
                    {showGarageFilter && (
                        <div className="space-y-2">
                            <div
                                className={`flex items-center p-2 rounded-md cursor-pointer ${selectedGarages.length === 0
                            ...
                            {garages.map(garage => (
                                <div
                                    key={garage.id}
                                    className={`flex items-center p-2 rounded-md cursor-pointer ${selectedGarages.includes(garage.id)
                                            ? 'bg-[#4e77f4] text-white'
                                            : darkMode ? 'bg-[#252830] hover:bg-[#353b48] text-white' : 'bg-gray-200 hover:bg-gray-300 text-black'
                                        }`}
                ...
                <div className="border-b-2 border-[#4e77f4]/80 pb-4">
                    ...
                    {showVehicleTypeFilter && (
                        <div className="space-y-2">
                            <div
                                className={`flex items-center p-2 rounded-md cursor-pointer ${selectedVehicleTypes.length === 0
                                        ? 'bg-[#4e77f4] text-white'
                                        : darkMode ? 'bg-[#252830] hover:bg-[#353b48] text-white' : 'bg-gray-200 hover:bg-gray-300 text-black'
                                    }`}
                            ...
                            {['car', 'motorcycle', 'truck'].map(type => (
                                <div
                                    key={type}
                                    className={`flex items-center p-2 rounded-md cursor-pointer ${selectedVehicleTypes.includes(type)
                                            ? 'bg-[#4e77f4] text-white'
                                            : darkMode ? 'bg-[#252830] hover:bg-[#353b48] text-white' : 'bg-gray-200 hover:bg-gray-300 text-black'
                                        }`}
                ...
                <div className="border-b-2 border-[#4e77f4]/80 pb-4">
                    ...
                    {showSeasonFilter && (
                        <div className="space-y-2">
                            <div
                                className={`flex items-center p-2 rounded-md cursor-pointer ${selectedSeasons.length === 0
                                        ? 'bg-[#4e77f4] text-white'
                                        : darkMode ? 'bg-[#252830] hover:bg-[#353b48] text-white' : 'bg-gray-200 hover:bg-gray-300 text-black'
                                    }`}
                            ...
                            {['winter', 'summer', 'all_season'].map(season => (
                                <div
                                    key={season}
                                    className={`flex items-center p-2 rounded-md cursor-pointer ${selectedSeasons.includes(season)
                                            ? 'bg-[#4e77f4] text-white'
                                            : darkMode ? 'bg-[#252830] hover:bg-[#353b48] text-white' : 'bg-gray-200 hover:bg-gray-300 text-black'
                                        }`}
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {widthOptions.map(width => (
                                        <button
                                            ...
                                            className={`px-2 py-1 text-sm rounded-md cursor-pointer ${selectedWidth === width
                                                    ? 'bg-[#4e77f4] text-white'
                                                    : darkMode ? 'bg-[#252830] hover:bg-[#353b48] text-white' : 'bg-gray-200 hover:bg-gray-300 text-black'
                                                }`}
                                        >
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {profileOptions.map(profile => (
                                        <button
                                            ...
                                            className={`px-2 py-1 text-sm rounded-md cursor-pointer ${selectedProfile === profile
                                                    ? 'bg-[#4e77f4] text-white'
                                                    : darkMode ? 'bg-[#252830] hover:bg-[#353b48] text-white' : 'bg-gray-200 hover:bg-gray-300 text-black'
                                                }`}
                                        >
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {diameterOptions.map(diameter => (
                                        <button
                                            ...
                                            className={`px-2 py-1 text-sm rounded-md cursor-pointer ${selectedDiameter === diameter
                                                    ? 'bg-[#4e77f4] text-white'
                                                    : darkMode ? 'bg-[#252830] hover:bg-[#353b48] text-white' : 'bg-gray-200 hover:bg-gray-300 text-black'
                                                }`}
                                        >
